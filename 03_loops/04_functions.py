...
def saludar_a(nombre): # type: ignore
  print(f"¡Hola {nombre}!")
...
def restar(a, b):
  """Resta dos números y devuelve el resultado""" # docstring documentar la funcion
  return a - b

print(restar.__doc__) # imprime el docstring
help(restar.__doc__)

# parámetros por defecto
def multiplicar(a, b = 2): # b es opcional y por defecto es 2
  return a * b
