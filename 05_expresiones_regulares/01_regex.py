...
if result: print("He encontrado el patrón en el texto")
else: print("No he encontrado el patrón en el texto")
...
text = "Me gusta Python. Pyhhon es lo máximo. Aunque Python no es tan difícil, ojo con Python"
pattern = "Py.hon" # el punto indica que puede ser cualquier caracter
...
pattern = "midu."
matches = re.finditer(pattern, text)
times = len(re.findall(pattern, text))
for match in matches:
  print(match.group(), match.start(), match.end())
print(f"He encontrado {times} coincidencias")
